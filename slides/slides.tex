...
\begin{frame}
    \begin{columns}[onlytextwidth]
        \begin{column}{0.25\textwidth}
            \includegraphics[width=0.9\textwidth]{green_blue_red.pdf}
        \end{column}
        \pause
        \begin{column}{0.25\textwidth}
\begin{minipage}{\textwidth}
            \vspace{3cm}
            \includegraphics[width=0.9\textwidth]{green_blue.pdf}
\end{minipage}
        \end{column}
        \pause
        \begin{column}{0.25\textwidth}
\begin{minipage}{\textwidth}
            \vspace{3cm}
            \includegraphics[width=0.9\textwidth]{green_blue_yellow.pdf}
\end{minipage}
        \end{column}
        \pause
        \begin{column}{0.25\textwidth}

            \includegraphics[width=0.9\textwidth]{green_yellow.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \centering
    \includegraphics[width=\textwidth]{strategy_subversion.pdf}
...
\begin{frame}
    \centering
    \includegraphics[width=\textwidth]{strategy_integration_manager.pdf}
...
\begin{frame}
    \centering
    \includegraphics[width=\textwidth]{strategy_dictator_and_lieutenants.pdf}
